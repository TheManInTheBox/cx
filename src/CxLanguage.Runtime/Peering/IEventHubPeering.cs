...
namespace CxLanguage.Runtime.Peering
{
    ...
    /// <summary>
    /// Event data for direct peer messages.
    /// </summary>
    ...
    /// <summary>
    /// Direct peer connection state and management.
    /// </summary>
    public class PeerConnection
    {
        ...
        public PeerConnectionState State { get; set; } = PeerConnectionState.Disconnected;
        public DateTimeOffset EstablishedAt { get; set; }
        public DateTimeOffset LastActivity { get; set; }
